...
{
    NSData *data = nil;
    if ([self.manager encryptionKeyDataAlreadyGenerated]) {
        data = [self.manager retrieveEncryptionKeyDataUsingPassword:self.password];
    } else {
        data = [self.manager generateEncryptionKeyDataUsingPassword:self.password];
    }
