...
{
    XCTAssertNil([[CDTEncryptionKeychainProvider alloc] init],
...
{
    self.mockManager.encryptionKeyDataAlreadyGeneratedResult = NO;

    [self.provider encryptionKey];

    XCTAssertTrue(self.mockManager.encryptionKeyDataAlreadyGeneratedExecuted &&
                      self.mockManager.generateEncryptionKeyDataExecuted,
...
{
    self.mockManager.encryptionKeyDataAlreadyGeneratedResult = NO;
    self.mockManager.generateEncryptionKeyDataResult = nil;
...
{
    self.mockManager.encryptionKeyDataAlreadyGeneratedResult = NO;
    self.mockManager.generateEncryptionKeyDataResult = self.encryptionKeyData;
...
{
    self.mockManager.encryptionKeyDataAlreadyGeneratedResult = YES;

    [self.provider encryptionKey];

    XCTAssertTrue(self.mockManager.encryptionKeyDataAlreadyGeneratedResult &&
                      self.mockManager.retrieveEncryptionKeyDataExecuted,
...
{
    self.mockManager.encryptionKeyDataAlreadyGeneratedResult = YES;
    self.mockManager.retrieveEncryptionKeyDataResult = nil;
...
{
    self.mockManager.encryptionKeyDataAlreadyGeneratedResult = YES;
    self.mockManager.retrieveEncryptionKeyDataResult = self.encryptionKeyData;
